...
import { usePlayerControls } from '../hooks/player.utils'
import TrackPlayer from 'react-native-track-player'
import { RootStackScreenProps, Routes } from '../navigation/routes'
import { songs } from '../songs'

const PlayerModal: FC<RootStackScreenProps<Routes.PLAYER>> = ({
  route: {
